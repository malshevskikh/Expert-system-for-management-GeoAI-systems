...
|----------------------------------|---------------------------------------------------------------------|--------------------------------------------------------------------|---------------------------------------------------------------------|--------------------------------------------------------------------|---------------------------------------------------------------------|--------------------------------------------------------------------|
|                                  |      Время без использования    экспертной системы (в секундах)     |      Время с использованием    экспертной системы (в секундах)     |      Время без использования    экспертной системы (в секундах)     |      Время с использованием экспертной    системы (в секундах)     |      Время без использования    экспертной системы (в секундах)     |      Время с использованием    экспертной системы (в секундах)     |
|     0 (без копий)                |     0.424                                                           |     0.712                                                          |     0.280                                                           |     0.690                                                          |     0.362                                                           |     0.816                                                          |
|     1 (общее количество: 2)      |     0.623                                                           |     0.924                                                          |     0.496                                                           |     0.737                                                          |     0.385                                                           |     0.929                                                          |
|     2 (общее количество: 3)      |     0.868                                                           |     0.899                                                          |     0.579                                                           |     0.775                                                          |     0.413                                                           |     0.912                                                          |
|     3 (общее количество: 4)      |     0.890                                                           |     0.884                                                          |     0.597                                                           |     1.007                                                          |     0.514                                                           |     0.931                                                          |
|     4 (общее количество: 5)      |     0.909                                                           |     0.879                                                          |     0.818                                                           |     0.979                                                          |     0.750                                                           |     1.019                                                          |
|     5 (общее количество: 6)      |     0.919                                                           |     1.031                                                          |     0.936                                                           |     1.020                                                          |     0.807                                                           |     1.069                                                          |
|     6 (общее количество: 7)      |     1.28                                                            |     0.906                                                          |     1.14                                                            |     1.083                                                          |     1.35                                                            |     0.917                                                          |
|     7 (общее количество: 8)      |     1.81                                                            |     0.914                                                          |     1.27                                                            |     1.160                                                          |     1.57                                                            |     1.201                                                          |
|     8 (общее количество: 9)      |     1.523                                                           |     0.964                                                          |     1.54                                                            |     0.948                                                          |     1.6                                                             |     1.232                                                          |
|     9 (общее количество: 10)     |     1.442                                                           |     1.295                                                          |     1.53                                                            |     1.222                                                          |     1.88                                                            |     1.255                                                          |
|     10 (общее количество: 11)    |     1.917                                                           |     1.398                                                          |     1.91                                                            |     1.36                                                           |     1.82                                                            |     1.319                                                          |
|     11 (общее количество: 12)    |     1.591                                                           |     1.343                                                          |     1.62                                                            |     1.329                                                          |     1.725                                                           |     1.36                                                           |
|     12 (общее количество: 13)    |     1.948                                                           |     1.15                                                           |     1.894                                                           |     1.43                                                           |     1.84                                                            |     1.247                                                          |
|     13 (общее количество: 14)    |     1.754                                                           |     1.377                                                          |     1.926                                                           |     1.685                                                          |     1.9                                                             |     1.607                                                          |
|     14 (общее количество: 15)    |     1.791                                                           |     1.67                                                           |     1.88                                                            |     1.743                                                          |     1.868                                                           |     1.747                                                          |
|     15 (общее количество: 16)    |     1.885                                                           |     1.73                                                           |     1.773                                                           |     1.754                                                          |     1.873                                                           |     1.78                                                           |
|     16 (общее количество: 17)    |     2.05                                                            |     1.78                                                           |     1.991                                                           |     1.912                                                          |     1.95                                                            |     1.8                                                            |
