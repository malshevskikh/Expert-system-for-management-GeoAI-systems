...
| | Время без использования экспертной системы (в секундах) | Время с использованием экспертной си-стемы (в секундах) |  Время без использования экспертной системы (в секундах) | Время с использованием экспертной си-стемы (в секундах) |  Время без использования экспертной системы (в секундах) | Время с использованием экспертной си-стемы (в секундах) |  Время без использования экспертной системы (в секундах) | Время с использованием экспертной си-стемы (в секундах) |
| ----------- | ----------- | ----------- | ----------- |
| 1      | 2       | 3       | 4       |
